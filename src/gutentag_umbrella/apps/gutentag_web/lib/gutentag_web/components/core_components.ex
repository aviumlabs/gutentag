defmodule GutentagWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(GutentagWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(GutentagWeb.Gettext, "errors", msg, opts)
    end
  end
